...
const Footer = () => {
  ...
  const footerLinks = [
    { to: '/', label: 'Home', testId: 'footer-home' },
    { to: '/cards', label: 'Cards', testId: 'footer-cards' },
    { to: '/about', label: 'About', testId: 'footer-about' },
    { to: '/services', label: 'Services', testId: 'footer-services' },
    { to: '/contact', label: 'Contact', testId: 'footer-contact' },
    { to: '/privacy', label: 'Privacy', testId: 'footer-privacy' }
  ];
  ...
  const features = [
    {
      icon: SparklesIcon,
      title: 'Digital Cards',
      description: 'Modern digital business cards'
    },
    {
      icon: HeartIcon,
      title: 'Favorites',
      description: 'Save and manage your favorite cards'
    },
    {
      icon: GlobeAltIcon,
      title: 'Global Reach',
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              Create and share professional digital business cards with cutting-edge technology
            </p>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-md border border-white/10 p-6">
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-3">
                  ...
                  <h5 className="text-white font-semibold text-lg">Newsletter</h5>
                </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 gap-4">
            <div className="text-white/60 text-sm text-center md:text-left">
              © {new Date().getFullYear()} FuturistCards. All Rights Reserved
            </div>
