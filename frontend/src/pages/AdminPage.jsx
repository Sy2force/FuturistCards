            ...
            {['overview', 'users', 'cards', 'activity'].map((tab) => (
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab 
                    ? '#ffffff'
                    : (currentTheme?.colors?.text?.secondary || '#a0aec0')
                }}
              >
                {tab}
              </button>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span style={{ color: currentTheme?.colors?.text?.secondary || '#a0aec0' }}>
                      Business Users
                    </span>
                    <span style={{ color: currentTheme?.colors?.text?.primary || '#ffffff' }}>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-yellow-500">
                      {cards.filter(c => c.status === 'reported').length}
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { name: 'API Response', status: '120ms', color: '#10b981' },
                    { name: 'Uptime', status: '99.9%', color: '#10b981' }
                  ].map((item, index) => (
                ...
                <table className="w-full">
                  <thead>
                    <tr style={{ backgroundColor: 'rgba(0,0,0,0.2)' }}>
                      ...
                      <th className="px-6 py-4 text-left" style={{ color: currentTheme?.colors?.text?.primary || '#ffffff' }}>Cards</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredUsers.map((u) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span 
                            ...
                            style={{
                              backgroundColor: u.role === 'business' ? 'rgba(139,92,246,0.2)' : 'rgba(59,130,246,0.2)',
                              color: u.role === 'business' ? '#a78bfa' : '#60a5fa'
                            }}
                          >
                            {u.role}
                          </span>
                        ...
                        <td className="px-6 py-4">
                          <span 
                            className="px-3 py-1 rounded-full text-sm"
                            style={{
                              backgroundColor: u.status === 'active' ? 'rgba(16,185,129,0.2)' : 'rgba(239,68,68,0.2)',
                        ...
                        <td className="px-6 py-4" style={{ color: currentTheme?.colors?.text?.primary || '#ffffff' }}>{u.cardsCount}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                    ...
                    <span 
                      ...
                      style={{
                        backgroundColor: card.status === 'active' 
                          ? 'rgba(16,185,129,0.2)' 
                          : 'rgba(245,158,11,0.2)',
                        color: card.status === 'active' ? '#34d399' : '#fbbf24'
                      }}
                    >
                      {card.status}
                    </span>
                ...
                {recentActivities.map((activity) => (
                  ...
                  >
                    <div 
                      ...
                      style={{ 
                        backgroundColor: activity.type === 'user_registered' 
                          ? 'rgba(16,185,129,0.2)'
