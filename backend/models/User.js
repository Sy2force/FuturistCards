...
const userSchema = new mongoose.Schema({
    ...
    avatarUrl: {
      ...
      validate: {
        validator: function(v) {
          ...
          return /^https?:\/\/.+\.(jpg|jpeg|png|gif|webp)$/i.test(v) || /^data:image\//.test(v);
        },
  ...
  password: {
    ...
    validate: {
      ...
      message: 'Password must contain at least 8 characters, 1 uppercase, 1 lowercase, 1 number, and 1 special character (!@#$%^&*_-)'
    }
  },
  image: {
    url: {
